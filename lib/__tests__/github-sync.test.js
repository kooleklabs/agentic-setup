...
describe('runGithubSync — --execute mode', () => {
  ...
  test('impl branch exists: createImplBranch throws → {ok: false, error}', async () => {
    implBranch.createImplBranch.mockImplementation(() => {
  ...
  test('--execute --dry-run: creates branch, skips SDK + commit, returns dryRun true', async () => {
    const r = await runGithubSync({
